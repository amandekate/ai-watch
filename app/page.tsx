  ...
  return (
    ...
    <div className='flex h-screen'>
      ...
      <div className='flex flex-row flex-1'>
        <div className='border-primary/5 border-2 max-w-xs slex flex-col gap-2 justify-between shadow-md rounded-md p-4'>
          {/* top section */}
      ...
      {Loading && <div className='z-50 absolute w-full h-full items-center bg-primary-foreground'>
